...
<div class="container">
  ...
  <form:form method="post" modelAttribute="book">  
    ...
    <div class="form-group">
    	<label>재고</label>
    	<select name = "available" class="form-control w200">
    		<option value="true" ${ book.available==true?"selected":"" }>있음</option>
    		<option value="false" ${ book.available==false?"selected":"" }>없음</option>
    	</select>
    </div>
    <hr />
    <div>
